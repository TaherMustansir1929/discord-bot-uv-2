...
class GoogleImagenImageGenerator:
    def __init__(self, api_key: str, base_url: str = "https://api.a4f.co/v1"):
        ...
        log_debug(f"Initialized GoogleImagenImageGenerator with base URL: {self.base_url}")
...
if __name__ == "__main__":
    google_imagen_image_generator("A majestic dragon soaring through cloudy skies at sunset, photorealistic, highly detailed")